...
for (const item of ['.codex-plugin', '.mcp.json', 'package.json', 'server.mjs', 'server.bundle.mjs', 'chrome-launcher.bundle.mjs', 'browser-supervisor.bundle.mjs', 'runtime', 'skills']) {
