...
for (const item of ['.codex-plugin', '.mcp.json', 'package.json', 'server.mjs', 'protocol.ts', 'profile-store.mjs', 'profile-store.d.mts', 'server.bundle.mjs', 'skills']) {
...
需要 Node.js 24。MCP 在本机管理多份简历，Chrome 扩展只负责观察和操作网页；最终申请提交由用户完成。
